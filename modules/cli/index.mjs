...
const argsToOptions = yargs
    ...
    yargs
      ...
      .option({
        a: {
          ...
          type: "boolean",
          describe:
            "Set this option if your primary key field is auto incrementing.",
        },
        c: {
          alias: "snake-case",
          type: "boolean",
          describe:
            "Set this option to use Snake Case mode (test_name). Default: Camel Case (CamelCase)",
        },
        d: {
          alias: "driver",
          choices: ["mysql"],
        ...
        s: {
          ...
          type: "boolean",
          describe:
            "Set this option if you want to add created and updated dates.",
        },
        t: {
          alias: "table-name",
          type: "string",
        ...
        w: {
          ...
          type: "boolean",
          describe:
            "Set this option if you want to use the Obremap Model Class Creation Wizard.",
        },
        x: {
          alias: "date-format",
          type: "string",
          describe:
            "Define the format of your dates. See: https://momentjs.com/docs/#/displaying/format/.",
        },
      })
      .version(false)
      .help("h")
      .example(
        "$0 make:model <name>",
        '"Simple way to create an Obremap Model Class"'
      )
      .example(
        "$0 make:model <name> -w",
        '"Create a model with the Obremap Model Class Creation Wizard."'
      );
  })
  .command(
    "make:connection <connection-name>",
      ...
      yargs
        ...
        .option({
          f: {
            alias: "config-file",
            describe:
              "Set this option to use the Obremap Config File (Recommended)",
            type: "boolean",
            default: true,
          },
          x: {
            ...
            describe:
              "Define you connection url (mysql://user:pass@hostname:port/database)",
            type: "string",
          },
          d: {
            alias: "driver",
        ...
        .check((args, opt) => {
          if (
            (args["connection-url"] &&
              regex.url.test(args["connection-url"])) ||
            (args["driver"] &&
              args["hostname"] &&
              args["username"] &&
              args["password"] &&
      ...
      yargs
        ...
        .option({
          ...
          m: {
            ...
            type: "boolean",
            describe:
              "Set this option if you want to create an Obremap Model Class.",
          },
          fields: {
            type: "array",
  ...
  .command("migrate:reset", "Rollback all database migrations", (yargs) => {
    yargs.option({}).version(false).help("h");
  })
...
const start = async (args) => {
  ...
  if (!newArgs["--how-import"] || newArgs["--how-import"] === null)
    newArgs["--how-import"] =
      obremapConfig && obremapConfig.howImport
        ? obremapConfig.howImport
        : config.howImport;
